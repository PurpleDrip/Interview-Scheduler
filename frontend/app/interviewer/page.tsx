...
export default function InterviewerPage() {
    ...
    const { register, handleSubmit, watch, formState: { errors } } = useForm<FormData>({
        defaultValues: {
            ...
            validUntil: toDateTimeLocal(new Date(Date.now() + 30 * 24 * 60 * 60 * 1000)),
        },
    });
        ...
        <div className="min-h-screen">
            ...
            <main className="max-w-4xl mx-auto px-6 py-12">
                <div className="mb-8 animate-fade-in">
                    <h2 className="text-4xl font-bold mb-3">Interviewer Availability</h2>
                    <p className="text-[var(--text-muted)] text-lg">
                        Submit your availability for conducting interviews. Our AI will match you with candidates.
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="card animate-fade-in">
                    ...
                    <div className="mb-8">
                        <h3 className="text-2xl font-semibold mb-6 flex items-center">
                            <span className="w-8 h-8 rounded-full bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center text-sm mr-3">1</span>
                            Personal Information
                        </h3>
                    ...
                    <div className="mb-8">
                        <h3 className="text-2xl font-semibold mb-6 flex items-center">
                            <span className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-sm mr-3">2</span>
                            Availability
                        </h3>
                        ...
                        {inputMethod === 'freetext' ? (
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Example: I'm available for interviews every Tuesday and Thursday afternoon from 2pm to 5pm, and Wednesday mornings from 10am to 12pm"
                                />
                        ...
                        <div className="mt-6">
                            ...
                            <textarea
                                ...
                                placeholder="Preferred interview format, meeting link, etc..."
                            />
                        </div>
                    </div>
